...
Note: This model and explanation is from [this GitHub repository](https://github.com/sssingh/hand-written-digit-classification/tree/master#MNIST-Classification-using-Neural-Network).  However, I have made my own custom comments on the code.
